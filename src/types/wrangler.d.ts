/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/types/wrangler.d.ts` (hash: 68ba109cf9b842a904f1d474fdbe826f)
// Runtime types generated with workerd@1.20260708.1 2025-11-25 nodejs_compat
interface __BaseEnv_Env {
	FORBID_LIST: KVNamespace;
	CAN_REPORT: KVNamespace;
	REPORT_THREAD_CHAIN: KVNamespace;
	CF_ACCOUNT_ID: "c56f01b66d3ce2234fb0012a345aa1c6";
	THREAD_CHAIN_KV_ID: "6acf800bb3fa47f88eb9d296a0808668";
	APP_SETTINGS: {"redirect_to_install":true,"can_use_clean":true,"accounts":["1152057650226401320","1176299970568147057","1226254289161158776","1443130827662823557"]};
	COMMAND_SETTINGS: {"log_run":false,"log_errors":true,"use_forbid_list":true,"install_mod_commands":true};
	REPORT_SETTINGS: {"allow_all":true,"can_report_in_servers":false,"report_banned":true,"thread_by_user":true,"message_source_lifetime":"1d 6h 30m"};
	LOOKUP_SETTINGS: {"slash_enabled":false,"allow_all":true};
	DISCORD_APP_ID: string;
	DISCORD_PUBLIC_KEY: string;
	DISCORD_BOT_TOKEN: string;
	SUPPORT_THREAD: string;
	CONTROL_GUILD: string;
	LOG_COMMAND_RUN: string;
	BULK_KV_API_TOKEN: string;
	API_SERVICE: Service /* entrypoint APILookup from antiscamapi */;
	REPORT: Service /* entrypoint ScamReportBridge from antiscamreport */;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CF_ACCOUNT_ID" | "THREAD_CHAIN_KV_ID" | "APP_SETTINGS" | "COMMAND_SETTINGS" | "REPORT_SETTINGS" | "LOOKUP_SETTINGS" | "DISCORD_APP_ID" | "DISCORD_PUBLIC_KEY" | "DISCORD_BOT_TOKEN" | "SUPPORT_THREAD" | "CONTROL_GUILD" | "LOG_COMMAND_RUN" | "BULK_KV_API_TOKEN">> {}
}
